...
| <a name="input_linuxNodeAmiType"></a> [linuxNodeAmiType](#input\_linuxNodeAmiType) | Specifies the AMI type to use for the execution and default nodes. Can be 'BOTTLEROCKET\_x86\_64' or 'AL2023\_x86\_64\_STANDARD' | `string` | `"AL2023_x86_64_STANDARD"` | no |
