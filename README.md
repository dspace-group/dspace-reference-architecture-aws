...
| <a name="input_executionNodeAmiType"></a> [executionNodeAmiType](#input\_executionNodeAmiType) | Specifies the AMI type to use for the execution and default nodes. Can be 'BOTTLEROCKET\_x86\_64' or 'AL2023\_x86\_64\_STANDARD' | `string` | `"AL2023_x86_64_STANDARD"` | no |
