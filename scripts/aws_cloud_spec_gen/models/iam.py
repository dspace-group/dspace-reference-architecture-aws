...
class Role:
    """! Class representation of AWS IAM Role."""
    ...
    def get_related_policies_ref(self) -> str:
        """! Method for getting string representation for this self.releated_policies.
...
class Policy:
    """! Class representation of AWS IAM policy."""
    ...
    def get_list_item(self) -> str:
        """! Method for getting HTML list element string from this object.
    ...
    def get_markdown_name(self) -> str:
        """! Method for getting Markdown href from this objects name.
